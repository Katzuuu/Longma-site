...
const Nav = () => {
  return (
    <nav className="flex items-center justify-between h-[75px] padding pr-0 shadow-xl overflow-hidden bg-white">
      <Logo />
      <ul className="flex items-center h-full select-none">
        ...
        <li className="relative h-full flex items-center group overflow-hidden">
          <div className="absolute bg-[#4181BA] top-0 -left-full w-full h-full group-hover:left-0 transition-all duration-300" />
