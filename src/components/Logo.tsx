          ...
          >
            ...
            >
              <svg viewBox="0 0 395.52 247.2" height="247.2" width="395.52">
                ...
                <g>
                  <svg viewBox="0 0 395.52 247.2" height="247.2" width="395.52">
                    <g transform="matrix(1,0,0,1,75.54432000000001,103.79169732193732)">
                      <svg
                        viewBox="0 0 244.43135999999996 39.61660535612535"
                        height="39.61660535612535"
                    ...
                    <path
                      id="square"
                      d="M183.273 97.792L183.273 35.393 6.858 35.393 6.858 211.807 183.273 211.807 183.273 149.408 179.7 149.408 179.7 208.235 10.431 208.235 10.431 38.965 179.7 38.965 179.7 97.792Z"
                      fill="#374151"
                      stroke="transparent"
                      data-fill-palette-color="primary"
                    ></path>
