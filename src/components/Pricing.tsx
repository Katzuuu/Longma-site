        ...
        <div className="h-[85%] bg-gray-100 pricingBox">
          ...
          <div className="px-9 mt-10">
            <div className="flex items-center justify-between mb-5">
              <p className="text-[13px]">Spracovanie miezd na 1 osobu</p>
              <p className="text-[#4181BA] text-sm text-right">14 €</p>
            </div>
            <div className="flex items-center justify-between mb-5">
              ...
              <p className="text-[#4181BA] text-sm text-right">30 €</p>
            </div>
        ...
        <div className="h-full bg-gradient-to-bl text-gray-100 from-[#4181BA] to-[#363795] pricingBox">
          ...
          <div className="px-9 mt-10">
            <div className="flex items-center justify-between mb-5">
              ...
              <p className="text-gray-300 text-sm text-right">10 €</p>
            </div>
            ...
            <div className="flex items-center justify-between mb-5">
              <p className="text-[13px]">Vypracovanie intrastátu</p>
              <p className="text-gray-300 text-sm text-right">10 € / položka</p>
            </div>
            ...
            <div className="flex items-center justify-between mb-5">
              ...
              <p className="text-gray-300 text-sm text-right">30 € / hodina</p>
            </div>
            ...
            <div className="flex items-center justify-between mb-5">
              ...
              <p className="text-gray-300 text-sm text-right">25€</p>
            </div>

            <div className="flex items-center justify-between mb-5">
              <p className="text-[13px]">Vypracovanie dane z nehnuteľností</p>
              <p className="text-gray-300 text-sm text-right">30€ / hodina</p>
            </div>
            ...
            <div className="flex items-center justify-between mb-5">
              ...
              <p className="text-gray-300 text-sm text-right">500 €</p>
            </div>
          </div>
        </div>
        <div className="h-[85%] bg-gray-100 pricingBox">
          ...
          <div className="px-9 mt-10">
            <div className="flex items-center justify-between mb-5">
              ...
              <p className="text-[#4181BA] text-sm text-right">50 - 100 €</p>
            </div>
            <div className="flex items-center justify-between mb-5">
              <p className="text-[13px]">
              ...
              <p className="text-[#4181BA] text-sm text-right">
                1 € neplatca DPH
                <br /> 1,20 € platca DPH
              </p>
            </div>
            ...
            <div className="flex items-center justify-between mb-5">
              ...
              <p className="text-[#4181BA] text-sm text-right">500 €</p>
            </div>
          </div>
        </div>
      </div>
